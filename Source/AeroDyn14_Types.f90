!STARTOFREGISTRYGENERATEDFILE 'C:\Users\bjonkman\Documents\DATA\DesignCodes\simulators\AeroDyn\SVNdirectory\trunk\Source/AeroDyn14_Types.f90'
!
...
! This module contains all of the user-defined types needed in AeroDyn14. It also contains copy, destroy, pack, and
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
      ...
      Int_BufSz   = Int_BufSz + 3  ! DWM_InitInputs: size of buffers for each call to pack subtype
      CALL DWM_PackInitInput( Re_Buf, Db_Buf, Int_Buf, InData%DWM_InitInputs, ErrStat2, ErrMsg2, .TRUE. ) ! DWM_InitInputs 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! DWM_InitInputs
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! DWM_InitInputs
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! DWM_InitInputs
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  IF ( Re_BufSz  .GT. 0 ) THEN 
  ...
  END IF
      ...
      Re_Xferred   = Re_Xferred   + 1
      CALL DWM_PackInitInput( Re_Buf, Db_Buf, Int_Buf, InData%DWM_InitInputs, ErrStat2, ErrMsg2, OnlySize ) ! DWM_InitInputs 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  END IF
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL DWM_UnpackInitInput( Re_Buf, Db_Buf, Int_Buf, OutData%DWM_InitInputs, ErrStat2, ErrMsg2 ) ! DWM_InitInputs 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      IF(ALLOCATED(Int_Buf)) THEN ! Ver
         ...
         DEALLOCATE(Int_Buf)
      END IF
      Int_BufSz   = Int_BufSz + 3  ! DWM_InitOutput: size of buffers for each call to pack subtype
      CALL DWM_PackInitOutput( Re_Buf, Db_Buf, Int_Buf, InData%DWM_InitOutput, ErrStat2, ErrMsg2, .TRUE. ) ! DWM_InitOutput 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! DWM_InitOutput
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! DWM_InitOutput
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! DWM_InitOutput
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  IF ( Re_BufSz  .GT. 0 ) THEN 
  ...
  Int_Xferred = 1
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL DWM_PackInitOutput( Re_Buf, Db_Buf, Int_Buf, InData%DWM_InitOutput, ErrStat2, ErrMsg2, OnlySize ) ! DWM_InitOutput 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL DWM_UnpackInitOutput( Re_Buf, Db_Buf, Int_Buf, OutData%DWM_InitOutput, ErrStat2, ErrMsg2 ) ! DWM_InitOutput 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
! 
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      Int_BufSz   = Int_BufSz + 3  ! DWM_ContStates: size of buffers for each call to pack subtype
      CALL DWM_PackContState( Re_Buf, Db_Buf, Int_Buf, InData%DWM_ContStates, ErrStat2, ErrMsg2, .TRUE. ) ! DWM_ContStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! DWM_ContStates
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! DWM_ContStates
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! DWM_ContStates
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  IF ( Re_BufSz  .GT. 0 ) THEN 
  ...
  Int_Xferred = 1
      ...
      CALL DWM_PackContState( Re_Buf, Db_Buf, Int_Buf, InData%DWM_ContStates, ErrStat2, ErrMsg2, OnlySize ) ! DWM_ContStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL DWM_UnpackContState( Re_Buf, Db_Buf, Int_Buf, OutData%DWM_ContStates, ErrStat2, ErrMsg2 ) ! DWM_ContStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
! 
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      Int_BufSz   = Int_BufSz + 3  ! DWM_DiscStates: size of buffers for each call to pack subtype
      CALL DWM_PackDiscState( Re_Buf, Db_Buf, Int_Buf, InData%DWM_DiscStates, ErrStat2, ErrMsg2, .TRUE. ) ! DWM_DiscStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! DWM_DiscStates
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! DWM_DiscStates
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! DWM_DiscStates
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  IF ( Re_BufSz  .GT. 0 ) THEN 
  ...
  Int_Xferred = 1
      ...
      CALL DWM_PackDiscState( Re_Buf, Db_Buf, Int_Buf, InData%DWM_DiscStates, ErrStat2, ErrMsg2, OnlySize ) ! DWM_DiscStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL DWM_UnpackDiscState( Re_Buf, Db_Buf, Int_Buf, OutData%DWM_DiscStates, ErrStat2, ErrMsg2 ) ! DWM_DiscStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
! 
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      Int_BufSz   = Int_BufSz + 3  ! DWM_ConstrStates: size of buffers for each call to pack subtype
      CALL DWM_PackConstrState( Re_Buf, Db_Buf, Int_Buf, InData%DWM_ConstrStates, ErrStat2, ErrMsg2, .TRUE. ) ! DWM_ConstrStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! DWM_ConstrStates
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! DWM_ConstrStates
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! DWM_ConstrStates
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  IF ( Re_BufSz  .GT. 0 ) THEN 
  ...
  Int_Xferred = 1
      ...
      CALL DWM_PackConstrState( Re_Buf, Db_Buf, Int_Buf, InData%DWM_ConstrStates, ErrStat2, ErrMsg2, OnlySize ) ! DWM_ConstrStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL DWM_UnpackConstrState( Re_Buf, Db_Buf, Int_Buf, OutData%DWM_ConstrStates, ErrStat2, ErrMsg2 ) ! DWM_ConstrStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
IF (ALLOCATED(SrcOtherStateData%ElPrNum)) THEN
  ...
  IF (.NOT. ALLOCATED(DstOtherStateData%ElPrNum)) THEN 
    ...
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstOtherStateData%ElPrNum.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
...
ENDIF
    ...
    DstOtherStateData%NERRORS = SrcOtherStateData%NERRORS
      CALL DWM_CopyOtherState( SrcOtherStateData%DWM_OtherStates, DstOtherStateData%DWM_OtherStates, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL AD14_Copyairfoil( SrcOtherStateData%AirFoil, DstOtherStateData%AirFoil, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL AD14_Copybeddoes( SrcOtherStateData%Beddoes, DstOtherStateData%Beddoes, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL AD14_Copydyninflow( SrcOtherStateData%DynInflow, DstOtherStateData%DynInflow, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL AD14_Copyelement( SrcOtherStateData%Element, DstOtherStateData%Element, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL AD14_Copyrotor( SrcOtherStateData%Rotor, DstOtherStateData%Rotor, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL AD14_Copywind( SrcOtherStateData%Wind, DstOtherStateData%Wind, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL AD14_Copyinducedvel( SrcOtherStateData%InducedVel, DstOtherStateData%InducedVel, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
IF (ALLOCATED(SrcOtherStateData%StoredForces)) THEN
  ...
  IF (.NOT. ALLOCATED(DstOtherStateData%StoredForces)) THEN 
    ...
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstOtherStateData%StoredForces.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
...
IF (ALLOCATED(SrcOtherStateData%StoredMoments)) THEN
  ...
  IF (.NOT. ALLOCATED(DstOtherStateData%StoredMoments)) THEN 
    ...
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstOtherStateData%StoredMoments.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
...
ENDIF
    DstOtherStateData%FirstWarn = SrcOtherStateData%FirstWarn
      CALL AD14_Copyeloutparms( SrcOtherStateData%ElOut, DstOtherStateData%ElOut, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
ENDIF
  ...
  CALL AD14_Destroyairfoil( OtherStateData%AirFoil, ErrStat, ErrMsg )
  CALL AD14_Destroybeddoes( OtherStateData%Beddoes, ErrStat, ErrMsg )
  CALL AD14_Destroydyninflow( OtherStateData%DynInflow, ErrStat, ErrMsg )
  CALL AD14_Destroyelement( OtherStateData%Element, ErrStat, ErrMsg )
  CALL AD14_Destroyrotor( OtherStateData%Rotor, ErrStat, ErrMsg )
  CALL AD14_Destroywind( OtherStateData%Wind, ErrStat, ErrMsg )
  CALL AD14_Destroyinducedvel( OtherStateData%InducedVel, ErrStat, ErrMsg )
...
ENDIF
  CALL AD14_Destroyeloutparms( OtherStateData%ElOut, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
   ...
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      Int_BufSz   = Int_BufSz + 3  ! DWM_OtherStates: size of buffers for each call to pack subtype
      CALL DWM_PackOtherState( Re_Buf, Db_Buf, Int_Buf, InData%DWM_OtherStates, ErrStat2, ErrMsg2, .TRUE. ) ! DWM_OtherStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! DWM_OtherStates
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! DWM_OtherStates
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! DWM_OtherStates
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  ...
  END IF
      ...
      Int_Xferred   = Int_Xferred   + 1
      CALL DWM_PackOtherState( Re_Buf, Db_Buf, Int_Buf, InData%DWM_OtherStates, ErrStat2, ErrMsg2, OnlySize ) ! DWM_OtherStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  END IF
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL DWM_UnpackOtherState( Re_Buf, Db_Buf, Int_Buf, OutData%DWM_OtherStates, ErrStat2, ErrMsg2 ) ! DWM_OtherStates 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ...
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      IF(ALLOCATED(Int_Buf)) THEN ! Rotor
         ...
         DEALLOCATE(Int_Buf)
      END IF
      Int_BufSz   = Int_BufSz + 3  ! DWM_Params: size of buffers for each call to pack subtype
      CALL DWM_PackParam( Re_Buf, Db_Buf, Int_Buf, InData%DWM_Params, ErrStat2, ErrMsg2, .TRUE. ) ! DWM_Params 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! DWM_Params
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! DWM_Params
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! DWM_Params
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  IF ( Re_BufSz  .GT. 0 ) THEN 
  ...
  Int_Xferred = 1
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL DWM_PackParam( Re_Buf, Db_Buf, Int_Buf, InData%DWM_Params, ErrStat2, ErrMsg2, OnlySize ) ! DWM_Params 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL DWM_UnpackParam( Re_Buf, Db_Buf, Int_Buf, OutData%DWM_Params, ErrStat2, ErrMsg2 ) ! DWM_Params 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
