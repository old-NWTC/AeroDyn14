...
!----------------------------------------------------------------------------------
SUBROUTINE turbine_average_velocity( p, OS, single_velocity, blade_num, element, average_velocity_array_local )
!..................................................................................
! This routine is called at every time step of the Aerodyn simuilation.
! To calculate the average of the wind speed of a specific blade ring
! the outpout is the average_velocity_array
!..................................................................................
    !USE TAVD,           ONLY: OS%TAVD%time_step_velocity_array, OS%TAVD%time_step_velocity
    ...
    INTEGER             ::   i
    !INTEGER             ::   OS%TAVD%time_step_velocity = -1
    !INTEGER,ALLOCATABLE,SAVE   :: OS%TAVD%time_step_velocity_array(:) ! counter of each section of the blade
    
    OS%TAVD%time_step_velocity = OS%TAVD%time_step_velocity +1
    
    IF ( OS%TAVD%time_step_velocity==0) THEN
       ALLOCATE ( average_velocity_array_local(p%ElementNum) )
       ALLOCATE ( OS%TAVD%time_step_velocity_array(p%ElementNum) )
       average_velocity_array_local(:)       = 0
       OS%TAVD%time_step_velocity_array(:)           = 0
       average_velocity_array_local(element) = single_velocity
       OS%TAVD%time_step_velocity_array(element)     = 1
       
    ELSE IF (OS%TAVD%time_step_velocity > 0) THEN
       DO i=1,p%ElementNum
          IF ( element == i) THEN
             OS%TAVD%time_step_velocity_array(element)     = OS%TAVD%time_step_velocity_array(element)+1
             average_velocity_array_local(element) = (average_velocity_array_local(element)*( (OS%TAVD%time_step_velocity_array(element)-1) ) + single_velocity) &
                                               / (OS%TAVD%time_step_velocity_array(element))
             IF ( element == p%ElementNum ) THEN
                IF ( blade_num == p%Bnum) THEN
                   CALL pass_velocity(p, OS, average_velocity_array_local)
                   OS%TAVD%time_step_velocity = -1
                   IF (ALLOCATED( average_velocity_array_local ))              DEALLOCATE ( average_velocity_array_local )
                   IF (ALLOCATED( OS%TAVD%time_step_velocity_array ))          DEALLOCATE ( OS%TAVD%time_step_velocity_array )
                END IF            
             END IF                
          END IF
       END DO
...
!----------------------------------------------------------------------------------
SUBROUTINE pass_velocity(p, OS, array_velocity)
!..................................................................................
! 
! 
!  
!..................................................................................
    !USE TAVD,            ONLY: OS%TAVD%average_velocity_array_temp, OS%TAVD%time_step_pass_velocity
    ...
    IF (OS%TAVD%time_step_pass_velocity==0) THEN
       ALLOCATE (OS%TAVD%average_velocity_array_temp(p%ElementNum))
       OS%TAVD%average_velocity_array_temp(:) = array_velocity(:)
    ELSE IF(OS%TAVD%time_step_pass_velocity>0) THEN
       OS%TAVD%average_velocity_array_temp(:) = array_velocity(:)
    END IF
...
!----------------------------------------------------------------------------------
SUBROUTINE filter_average_induction_factor( OS, p, y, thrust_force, num_of_element, dr_blade)
!..................................................................................
! This routine is called at every time step of the Aerodyn simuilation.
! The output of the subroutine is induction factor at this time step 
! and the average induction factor through all the time steps which have been simulated
!.................................................................................. 
    !USE TAVD,           ONLY: OS%TAVD%time_step_force, OS%TAVD%swept_area, OS%TAVD%average_velocity_array, OS%TAVD%average_velocity_array_temp
    !USE DWN_OutputType, ONLY: OS%induction_factor, OS%turbine_thrust_force
    !USE Blade,          ONLY: R
    ...
    OS%TAVD%time_step_force = OS%TAVD%time_step_force +1
    
    
    IF ( OS%TAVD%time_step_force==0) THEN
       ALLOCATE (y%induction_factor ( num_of_element ))
       ALLOCATE (OS%TAVD%average_velocity_array ( num_of_element ))
       ALLOCATE (y%turbine_thrust_force (num_of_element ))
       ALLOCATE (OS%TAVD%swept_area (num_of_element ))
       ...
       y%induction_factor = induction_factor_local_temp
       OS%TAVD%average_velocity_array = OS%TAVD%average_velocity_array_temp
    
    ELSE IF ( OS%TAVD%time_step_force>0) THEN
       ...
       CALL calculate_induction_factor ( p, y%turbine_thrust_force , OS%TAVD%swept_area , num_of_element, OS%TAVD%average_velocity_array_temp, induction_factor_local_temp )
       y%induction_factor = ( y%induction_factor(:) * OS%TAVD%time_step_force + induction_factor_local_temp(:) ) / ( OS%TAVD%time_step_force+1 )
       OS%TAVD%average_velocity_array = ( OS%TAVD%average_velocity_array(:) * OS%TAVD%time_step_force + OS%TAVD%average_velocity_array_temp(:) ) / ( OS%TAVD%time_step_force+1 )
    END IF
...
!----------------------------------------------------------------------------------
SUBROUTINE calculate_mean_u( OS, p, u, num_element,r_t,turbine_mean_velocity,TI_normalization, FAST_Time )
!..................................................................................
...
!.................................................................................. 
    !USE TAVD,                          ONLY : OS%TAVD%average_velocity_array
    !USE read_turbine_position_data   , ONLY : OS%RTPD%SimulationOrder_index,OS%RTPD%upwindturbine_number
    !USE weighting_method             , ONLY : OS%weighting_method%sweptarea,OS%weighting_method%weighting_denominator
    !USE read_upwind_result_file_data , ONLY : OS%Upwind_result%upwind_TI
    !USE Blade                        , ONLY : R
    ...
    ALLOCATE (OS%weighting_method%sweptarea(num_element))
    
    OS%weighting_method%weighting_denominator = 0
    ...
    DO i=1, num_element-1,1
       OS%weighting_method%sweptarea (i) = Pi * (node_radius (i+1) **2 - node_radius (i) **2)
    END DO
    OS%weighting_method%sweptarea (num_element) = Pi * (p%RotorR**2-node_radius (num_element)**2) ! ring area
    
    DO i=1,num_element
       OS%weighting_method%weighting_denominator = OS%weighting_method%weighting_denominator + OS%weighting_method%sweptarea (i)   ! denominator
    END DO
    
    ! calculate the mean velocity of the turbine using weighting method
    DO i=1,num_element 
       turbine_mean_velocity = turbine_mean_velocity + OS%weighting_method%sweptarea (i) / OS%weighting_method%weighting_denominator * OS%TAVD%average_velocity_array(i)       
    END DO
...
!----------------------------------------------------------------------------------
SUBROUTINE get_initial_condition( OS, p, u, y, induc_array, r_t, element_num, r_w, U_w )
!..................................................................................
...
!..................................................................................
   ...
   !-------------------------------------------------------------------------------------------------
    ...
    !DO i=1,element_num
       !avg_induction_factor = avg_induction_factor + OS%weighting_method%sweptarea (i) / OS%weighting_method%weighting_denominator * induc_array(i)       
    !END DO
    
    !OS%skew_angle = 0.60*avg_induction_factor*NacYaw *(-1)    ! minus sign means different direction
...
!-------------------------------------------------------------------------
SUBROUTINE calculate_wake(OS, p, y, r_w, U_w, element_num, U, b)
!..................................................................................
...
!..................................................................................
    ...
    !REAL                    ::   OS%DWDD%ppR                           ! Point_per_R_resoulution
    ...
    !INTEGER                 ::   OS%DWDD%n_x_vector
    !INTEGER                 ::   OS%DWDD%n_r_vector
    ...
    !REAL                    ::    OS%DWDD%X_length                     ! normalized length in axial direction
    INTEGER                 ::    np_r                         ! point per radial distance
    !INTEGER                 ::    OS%DWDD%np_x                         ! point per axial distance
    REAL                    ::    delrad                       ! delta r
    REAL                    ::    delaxi                       ! delta x
   ...
   !REAL, ALLOCATABLE       ::    OS%DWDD%Turb_Stress_DWM(:,:)
   ...
   !REAL, ALLOCATABLE       ::    VOL_r_ilow (:,:)
    ...
    D_WTG     = 2.0
    R_length  = Domain_R
    OS%DWDD%X_length  = Domain_X
    
    OS%TI_original = y%TI*(y%Mean_FFWS/p%Uambient)    ! calculate the TI if under ambient wind speed

    np_r       =  OS%DWDD%ppR          ! per R   ie. R resolution is 50
    OS%DWDD%np_x       =  OS%DWDD%ppR          ! per D   ie. X resolution is 50
    delrad     =  R_WTG/np_r   ! dr
    delaxi     =  D_WTG/OS%DWDD%np_x   ! dx
    OS%DWDD%n_x_vector =  floor((OS%DWDD%X_length)/D_WTG*OS%DWDD%np_x)      ! number of point in equally spaced array x_vector
    OS%DWDD%n_r_vector =  floor((R_length)/R_WTG*np_r)      ! number of point in equally spaced array r_vector

    ! create coordinate vectors
    ALLOCATE    (x_vector(OS%DWDD%n_x_vector))                             
    ALLOCATE    (r_vector(OS%DWDD%n_r_vector))
    ! similar to linspace function
    x_vector   = ( (OS%DWDD%X_length-delaxi)/(OS%DWDD%n_x_vector-1 ) )*[(i,i=1,OS%DWDD%n_x_vector)]+(0-( (OS%DWDD%X_length-delaxi)/(OS%DWDD%n_x_vector-1) ))        
    r_vector   = ( (R_length-delrad)/(OS%DWDD%n_r_vector-1 ) )*[(i,i=1,OS%DWDD%n_r_vector)]+(0-( (R_length-delrad)/(OS%DWDD%n_r_vector-1) )) 
    
    ! Create the F1 filter
    
    CALL create_F1_filter (F1_vector, filter1, length_F1_vector,OS%DWDD%np_x,OS%DWDD%X_length)
         !OPEN (unit=25,file="DWM\results\F1_filter.txt")
         !WRITE (25,'(f13.6)'), F1_vector(:)
         !CLOSE(25)
         
    CALL create_F2_filter (F2_vector, filter2, OS%DWDD%np_x, length_F1_vector)
    ...
    ALLOCATE (V               (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (U               (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))    !axial velocity matrix
    ALLOCATE (visc            (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (visc_DWM        (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (du_dr_DWM       (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (du_dr_total     (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (OS%DWDD%Turb_Stress_DWM (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    !ALLOCATE (TI_DWM          (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    !ALLOCATE (U_face          (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector-1))
    !ALLOCATE (VOL_x_jhigh     (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector-1))
    !ALLOCATE (VOL_x_jlow      (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector-1))
    !ALLOCATE (VOL_r_ihigh     (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector-1))
    !ALLOCATE (VOL_r_ilow      (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector-1))
    ALLOCATE (visc_wake         (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (visc_wake1        (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (visc_wake2        (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (alfa_1            (OS%DWDD%n_r_vector           ))
    ALLOCATE (alfa_2            (OS%DWDD%n_r_vector           ))
    ALLOCATE (du_dr_tot         (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (shear_flag        (OS%DWDD%n_r_vector           )) 
    ALLOCATE (One_div_du_dr_DWM (OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    ALLOCATE (visc_fac          (OS%DWDD%n_r_vector           ))
    
    ALLOCATE (main_diagonal     (OS%DWDD%n_r_vector           ))
    ALLOCATE (sub_diagonal      (OS%DWDD%n_r_vector           ))
    ALLOCATE (sup_diagonal      (OS%DWDD%n_r_vector           ))

    V                  = 0
    U                  = 0
    visc               = 0
    du_dr_DWM          = 0
    OS%DWDD%Turb_Stress_DWM    = 0
    !TI_DWM             = 0
    !U_face             = 0
    !VOL_x_jhigh        = 0
    !VOL_x_jlow         = 0
    ...
    !%%%% BOUNDARY CONDITIONS
    ! ROTOR PLANE
    ALLOCATE (bin_filter(OS%DWDD%n_r_vector))
    DO i=1,OS%DWDD%n_r_vector
    ...
    ALLOCATE (U_tmp(n_xi +n_U_tmp_2))    !  =OS%DWDD%n_r_vector
    U_tmp = (/U_tmp_1, U_tmp_2/)
    U (1,:) = U_tmp(1:OS%DWDD%n_r_vector)
    ...
    !%%%% SOLVING FLOW FIELD
    ALLOCATE  (b(OS%DWDD%n_x_vector))
    ALLOCATE  (counter(OS%DWDD%n_x_vector))
              counter=1
    ALLOCATE (AugMat (OS%DWDD%n_r_vector,OS%DWDD%n_r_vector+1) )
    ALLOCATE (Soln   (OS%DWDD%n_r_vector)              )

    ALLOCATE (mat(OS%DWDD%n_r_vector,OS%DWDD%n_r_vector))
    ALLOCATE (RHS(OS%DWDD%n_r_vector))

    n_r_vec_DWM = floor(OS%DWDD%ppR*Domain_R)
    ...
    u_star_DEF     = ( (  (OS%TI_original/100)**2 * UU_DEF_UU_ABL * abs(UW_DEF_UU_DEF) )**2 )**0.25;
    
    Shear_add_du_dz = u_star_ABL / l_star_ABL
    
    !k_wiener = du_dz_ABL + delrad**2

    DO j=2, OS%DWDD%n_x_vector, 1  ! start from the plane next to the rotor plane

    !==== Calculating wake width "b" where 95% of the deficit is captured
      dr_DWM = 1.0/OS%DWDD%ppR
       ...
       DO i = 2,NINT( OS%DWDD%ppR )
          Def_DWM_mixL = ( 1- U(j-1,i) ) * dA_DWM(i) + Def_DWM_mixL
       END DO
       DO b_counter = NINT(OS%DWDD%ppR)+1, n_r_vec_DWM-1          
       ...
       DO i=2,(OS%DWDD%n_r_vector-1),1      ! starts from the point next to the hub center
       ...
       AugMat (1:OS%DWDD%n_r_vector, 1:OS%DWDD%n_r_vector) = TRANSPOSE(mat)
       AugMat (:           , OS%DWDD%n_r_vector+1) = RHS
       NumEqu                              = OS%DWDD%n_r_vector
       ...
       DO I = 2,OS%DWDD%n_r_vector-1
           main_diagonal (I) = AugMat(I,I)
           sub_diagonal  (I) = AugMat(I,I-1)
           sup_diagonal  (I) = AugMat(I,I+1)
       END DO
       
       main_diagonal (OS%DWDD%n_r_vector) = AugMat(OS%DWDD%n_r_vector, OS%DWDD%n_r_vector)
       sub_diagonal  (OS%DWDD%n_r_vector) = AugMat(OS%DWDD%n_r_vector, OS%DWDD%n_r_vector-1)
       sup_diagonal  (OS%DWDD%n_r_vector) = 0
       ...
       DO i=1,OS%DWDD%n_r_vector,1
         !OS%DWDD%Turb_Stress_DWM(j-1,i) = visc_DWM(j-1,i) * du_dr_total(j-1,i)
         OS%DWDD%Turb_Stress_DWM(j-1,i) = visc(j-1,i) * du_dr_DWM(j-1,i)
       END DO
   
       ! Control calculatoins of mass flux over cells
  
       !!DO i=1,OS%DWDD%n_r_vector-1,1
    ...
    b(OS%DWDD%n_x_vector) = b(OS%DWDD%n_x_vector-1)
    
    IF (ALLOCATED( V ))                  DEALLOCATE ( V )
    IF (ALLOCATED( visc ))               DEALLOCATE ( visc )
    IF (ALLOCATED( du_dr_DWM ))          DEALLOCATE ( du_dr_DWM )
    !IF (ALLOCATED( OS%DWDD%Turb_Stress_DWM ))    DEALLOCATE ( OS%DWDD%Turb_Stress_DWM )
    ...
    !WRITE(10)   OS%DWDD%ppR,Domain_R                                                               ! write the length of the velocity vector                                                                                                                                                                      
    !CLOSE(10)
    
    !OPEN(unit = 10, status='replace',file='DWM\results\Uvelocity.bin',form='unformatted')          
    !WRITE(10)   U(floor(spacing_turbine * OS%DWDD%ppR)+1,:)  ! write the wind data of the plane where the downstream turbine locates                                                                                                                                                                                                                                                                                                    
    !CLOSE(10)
...
!-------------------------------------------------------------------------------
FUNCTION filter_velocity (OS,p,u,x,xd,z,y,timestep,y_0,z_0,wake_radius)
!...............................................................................
...
!---------------------------------------------------------------------------------
SUBROUTINE Get_wake_center ( OS, p, y, u, x, xd, z, wakewidth, wake_center )
!................................................................................
...
!.................................................................................
    !USE DWM_Wake_Deficit_Data, ONLY : OS%DWDD%n_x_vector,OS%DWDD%ppR 
    !USE MeanderData 
    ...
    TYPE(DWM_OutputType),          INTENT(INOUT)  :: y
    TYPE(DWM_InputType),           INTENT(INOUT)  :: u           ! An initial guess for the input; input mesh must be defined
    TYPE(DWM_ContinuousStateType), INTENT(  OUT)  :: x           ! Initial continuous states
    TYPE(DWM_DiscreteStateType),   INTENT(  OUT)  :: xd          ! Initial discrete states
    TYPE(DWM_ConstraintStateType), INTENT(INOUT)  :: z           ! Initial guess of the constraint states
    ...
    !-------------------------------------------------------------
    !!OS%DWDD%n_x_vector = 1700
    !!ALLOCATE  (wakewidth(OS%DWDD%n_x_vector)) 
    !!wakewidth = 50
    !!OS%DWDD%ppR = 50
    !---------------------------------------------------------------
    ...
    DWM_time_step = (2*p%RotorR/OS%DWDD%ppR)/Modified_U          ! resolution (126m/50) / wind speed (8m/s) => make sure there is always a wake width at every time step
    ...
    flying_time       = OS%meandering_data%moving_time       
    OS%meandering_data%scale_factor      = 10       ! to decrease the calculation time
    ...
    DO release_time=1,simulation_time_length,1                        
       wake_center (release_time,2,1) = Modified_U * (DWM_time_step*OS%meandering_data%scale_factor) +0             


       !temp_center_wake (:) = AD_WindVelocityWithDisturbance(  (REAL(((release_time-1)+1)*DWM_time_step*OS%meandering_data%scale_factor,ReKi)), &
       ...
       wake_center (release_time,2,2) = temp_center_wake (2) * (DWM_time_step*OS%meandering_data%scale_factor) * U_Scale_Factor + wake_center (release_time,1,2)+ &
                                        local_skew_angle(OS%NacYaw, OS%ct_tilde, wake_center (release_time,2,1), NINT(OS%DWDD%ppR), OS%DWDD%ppR) * x_step !+ &
                                        !rotation_lateral_offset( wake_center (release_time,2,1) )
                                        
       wake_center (release_time,2,3) = temp_center_wake (3) * (DWM_time_step*OS%meandering_data%scale_factor) * U_Scale_Factor + wake_center (release_time,1,3)
    END DO


    DO flying_time = 2,OS%meandering_data%moving_time,1
       DO release_time = 1,simulation_time_length,1
       wake_center (release_time,flying_time+1,1) = wake_center (release_time,flying_time+1-1,1) + Modified_U * (DWM_time_step*OS%meandering_data%scale_factor)
   
       temp_velocity(:) = filter_velocity (OS,p,u,x,xd,z,y,((release_time-1)+1)*DWM_time_step*OS%meandering_data%scale_factor, wake_center (release_time,flying_time+1-1,2), &
                                          wake_center (release_time,flying_time+1-1,3), wakewidth((flying_time-1)*OS%meandering_data%scale_factor) )

       !!!--------- temp data------
       test_1 = temp_velocity (2) * (DWM_time_step*OS%meandering_data%scale_factor) * U_Scale_Factor  + wake_center (release_time,flying_time,2)+ &
                 local_skew_angle(OS%NacYaw, OS%ct_tilde, wake_center (release_time,flying_time,1), wakewidth((flying_time-1)*OS%meandering_data%scale_factor), OS%DWDD%ppR) * x_step
       test_2 = temp_velocity (3) * (DWM_time_step*OS%meandering_data%scale_factor) * U_Scale_Factor  + wake_center (release_time,flying_time,3)
       !!!-------------------------
       
       wake_center (release_time,flying_time+1,2) = temp_velocity (2) * (DWM_time_step*OS%meandering_data%scale_factor) * U_Scale_Factor  + wake_center (release_time,flying_time,2)+ &
                 local_skew_angle(OS%NacYaw, OS%ct_tilde, wake_center (release_time,flying_time,1), wakewidth((flying_time-1)*OS%meandering_data%scale_factor), OS%DWDD%ppR) * x_step  !+ &
       ...
       wake_center (release_time,flying_time+1,3) = temp_velocity (3) * (DWM_time_step*OS%meandering_data%scale_factor) * U_Scale_Factor  + wake_center (release_time,flying_time,3)
...
!------------------------------------------------------------------------------------------------ 
FUNCTION shifted_velocity( ZTime, p, OS, y, z, upwind_mean_u, Uwake, WakeCenter,spacing,angle)
!............................................................................
...
!............................................................................
    ...
    !ALLOCATE  (Uwake(NINT( OS%DWDD%ppR*Rdomain ))) ! the axis symmetrical velocity
...
!----------------------------------------------------------------------------------
SUBROUTINE smooth_out_wake(OS, p, Uvelocity,Uwake_center,wake_array,spacing,angle,velocity_matrix)
!..................................................................................
...
!..................................................................................
    !USE DWM_Wake_Deficit_Data,    ONLY: OS%DWDD%n_x_vector, OS%DWDD%n_r_vector, OS%DWDD%ppR
    !USE DWM_ParameterType,        ONLY: p%hub_height, p%WakePosition_1
    !USE smooth_out_wake_data,     ONLY: OS%SmoothOut%length_velocity_array
    ...
    !INTEGER              ::   OS%SmoothOut%length_velocity_array     ! the length of velocity_array
    INTEGER              ::   low
    INTEGER              ::   high
    INTEGER              ::   i,j,k,n
    INTEGER              ::   counter
    ...
    !OS%SmoothOut%length_velocity_array = NINT(1.2*R)
    
    !ALLOCATE   ( Uvelocity(OS%DWDD%n_x_vector,OS%DWDD%n_r_vector) )
    ...
    ALLOCATE   ( velocity_array (OS%SmoothOut%length_velocity_array) )
    !ALLOCATE   ( velocity_matrix (2*OS%SmoothOut%length_velocity_array,2*OS%SmoothOut%length_velocity_array) )  ! twice the size of the velocity array
    ALLOCATE   ( counter_array (OS%SmoothOut%length_velocity_array) )
   ...
   !-------------------------------------------------------------------------------------------------
    DO i=1,p%WakePosition_1,1
       DO j=1,2*OS%SmoothOut%length_velocity_array,1                        ! y axis
          DO k=1,2*OS%SmoothOut%length_velocity_array,1                     ! z axis
             y = (0-OS%SmoothOut%length_velocity_array) + (j-1)             ! y coordinate
             z = (p%hub_height-OS%SmoothOut%length_velocity_array) + (k-1)    ! z coordinate
             velocity_matrix(j,k) = velocity_matrix(j,k) + smooth_wake_shifted_velocity( OS, p, y, z, Uvelocity(floor(spacing * OS%DWDD%ppR)+1,:), Uwake_center(:,:,:),spacing,i,angle)
                       !velocity_matrix(j,k) = velocity_matrix(j,k) + smooth_wake_shifted_velocity( y, z, Uvelocity(floor(4.4 * OS%DWDD%ppR)+1,:), Uwake_center(:,:,:),4.4,i)
          END DO
       END DO
       counter = counter+1
    END DO
   ...
   !-------------------------------------------------------------------------------------------------
    DO i=1,OS%SmoothOut%length_velocity_array,1                          ! velocity array
       DO j=1,2*OS%SmoothOut%length_velocity_array,1                       ! velocity_matrix (j,:)
          DO k=1,2*OS%SmoothOut%length_velocity_array,1                    ! velocity_matrix (:,k)    
             y = (0-OS%SmoothOut%length_velocity_array) + (j-1)            ! y coordinate
             z = (p%hub_height-OS%SmoothOut%length_velocity_array) + (k-1)   ! z coordinate
    ...
    DO i=1,OS%SmoothOut%length_velocity_array,1                           
...
!------------------------------------------------------------------------------------------------ 
FUNCTION smooth_wake_shifted_velocity( OS, p, y_coor, z_coor, Uwake, WakeCenter,spacing,time_position,angle)
!............................................................................
! This routine is called to get the DWM wake velocity at a certain point in the downstream turbine plane
! Consideirng the meandered wake center
! Uwake(:) is the axial velocity of the wake at the downstream turbine plane
...
!............................................................................
    ...
    !USE    MeanderData,               ONLY: OS%meandering_data%scale_factor
...
!----------------------------------------------------------------------------------
FUNCTION TI_downstream_total (OS, p, y, spacing,angle,velocity_matrix)   ! name should be calculate_TI_downstream
!..................................................................................
...
!..................................................................................
    !USE  DWM_Wake_Deficit_Data,           ONLY: OS%DWDD%Turb_Stress_DWM, OS%DWDD%n_x_vector, OS%DWDD%n_r_vector, OS%DWDD%ppR
    !USE  DWM_OutputType,                  ONLY: OS%wake_position,OS%wake_u
    !USE  MeanderData,                     ONLY: OS%meandering_data%moving_time, OS%meandering_data%scale_factor
    ...
    INTEGER            ::  cross_plane_position_TI   ! the cross plane position which to be investigated in term of the OS%DWDD%n_x_vector
   ...
   !------------------------------------------------------------------------------------------------- 
    ...
    ALLOCATE (TI_downstream_matrix(OS%DWDD%n_x_vector,OS%DWDD%n_r_vector))
    c_uw = (0.7550 - OS%TI_original/100 *1.75) / 2
    
    DO i=1,OS%DWDD%n_x_vector
       DO j=1,OS%DWDD%n_r_vector     
          TI_downstream_matrix(i,j) = abs( ( 1/c_uw *OS%DWDD%Turb_Stress_DWM(i,j)   ) )**0.5
       END DO
    END DO
   ...
   !------------------------------------------------------------------------------------------------- 
    cross_plane_position_TI = ANINT( OS%DWDD%ppR*spacing+1 )
                     !cross_plane_position_TI = ANINT( OS%DWDD%ppR*4.4+1 )
    cross_plane_position_ds = ANINT( (OS%DWDD%ppR/OS%meandering_data%scale_factor)*spacing+1 )  ! the moving time index of the cross plane in the wake_position(:,:,:)
                     !cross_plane_position_ds = ANINT( (OS%DWDD%ppR/OS%meandering_data%scale_factor)*4.4+1 )
    ...
    DO i=1,p%WakePosition_1,1
       DO j=NINT(HubHt-Rscale*p%RotorR),NINT(HubHt+Rscale*p%RotorR),1      ! Z direction
          DO k=1,NINT(2*Rscale*p%RotorR)+1,1                         ! Y direction
             ...
             distance_index = FLOOR(distance/(p%RotorR/OS%DWDD%ppR)) + 1
   ...
   !------------------------------------------------------------------------------------------------- 
    zero_spacing = 0
    initial_timestep = 1
    !ALLOCATE (velocity_matrix(2*OS%SmoothOut%length_velocity_array,2*OS%SmoothOut%length_velocity_array))
    
    DO i=1,2*OS%SmoothOut%length_velocity_array,1                                                        ! velocity_matrix (i,:)
      DO j=1,2*OS%SmoothOut%length_velocity_array,1                                                        ! velocity_matrix (i,:)  
          y_coor = (0-OS%SmoothOut%length_velocity_array) + (i-1)                                              ! y coordinate
          z_coor = (p%hub_height-OS%SmoothOut%length_velocity_array) + (j-1)                                     ! z coordinate 
          TI_apprant_accumulation = TI_apprant_accumulation + &
                                    !(smooth_wake_shifted_velocity(y,z,OS%wake_u(floor(spacing_turbine * OS%DWDD%ppR)+1,:), OS%wake_position(:,:,:),spacing_turbine,k) - &
                                    !velocity_matrix(i,j))**2
                                    (velocity_matrix(i,j) - &
                                    smooth_wake_shifted_velocity(OS, p, y_coor, z_coor, y%wake_u(floor(spacing * OS%DWDD%ppR)+1,:), y%wake_position(:,:,:),zero_spacing,initial_timestep,angle))**2
                                           !smooth_wake_shifted_velocity(y,z,OS%wake_u(floor(4.4 * OS%DWDD%ppR)+1,:), OS%wake_position(:,:,:),zero_spacing,initial_timestep))**2
          counter2=counter2+1
      END DO
    END DO
...
!----------------------------------------------------------------------------------
FUNCTION smallscale_TI (OS, p, y, spacing,angle,velocity_matrix)   
!..................................................................................
...
!..................................................................................
   ...
   !------------------------------------------------------------------------------------------------- 
    ...
    DO i=1,OS%DWDD%n_x_vector
       DO j=1,OS%DWDD%n_r_vector    
          TI_downstream_matrix(i,j) = abs( ( 10/3*OS%DWDD%Turb_Stress_DWM(i,j)   ) )**0.5
       END DO
    END DO
...
!----------------------------------------------------------------------------------
SUBROUTINE read_turbine_position( OS, p, u )
!..................................................................................
...
!------------------------------------------------------------------------------------------------ 
SUBROUTINE read_upwind_result_file( OS, p, u )
!............................................................................
...
!............................................................................
    ...
    !USE read_turbine_position_data, ONLY:OS%RTPD%upwindturbine_number,OS%RTPD%upwind_turbine_index,OS%RTPD%WT_index,OS%RTPD%downwindturbine_number,OS%RTPD%SimulationOrder_index,OS%RTPD%Turbine_sort_order
    ...
    IF (p%RTPD%SimulationOrder_index > 0) THEN                ! not for the base 0 turbine
        IF (p%RTPD%downwindturbine_number /= 0 ) THEN         ! not for the turbines that don't have a downwind turbine
            OS%SmoothOut%length_velocity_array = NINT(1.2*p%RotorR)
            ...
            ALLOCATE ( u%Upwind_result%vel_matrix                (p%RTPD%downwindturbine_number,2*OS%SmoothOut%length_velocity_array,2*OS%SmoothOut%length_velocity_array) ) 
        END IF
    END IF
...
!------------------------------------------------------------------------------------------------ 
SUBROUTINE write_result_file(OS,p,y,u)
!............................................................................
...
!bjj: use GetNewUnit() and parameters instead of "25" and "10". "10" is especially bad, because some other file is bound to be using it!    
    ...
    IF (p%RTPD%SimulationOrder_index == 0) THEN
            ...
            WRITE (write_unit)   OS%WMC%wake_width(:)                                                                                                                                                                                              
            CLOSE (write_unit)
...
!------------------------------------------------------------------------------------------------
SUBROUTINE calculate_SD_averagePower( OS,y )
!------------------------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------------------------
    ...
    y%mean_SDgenpwr = y%total_SDgenpwr / OS%SDtimestep
